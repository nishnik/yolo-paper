...
\usepackage{hyperref}
\usepackage{cite}
\usepackage{graphicx, amsmath, fixmath, caption, amssymb, tabu}
...
\noindent \includegraphics[scale=0.45]{fignew1}
