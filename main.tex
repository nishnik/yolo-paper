...
% 1
\bibitem{}
Sanskruti Patel, Priti Sajja, Atul Patel, "Fuzzy Logic based Expert System for Students’ Performance Evaluation in Data Grid Environment", \emph{International Journal of Scientific & Engineering Research}, Volume 5, Issue 1, January-2014


% 2
\bibitem{IEEEhowto:Chrysa}
Chrysafiadi Konstantina, Virvou Maria, "Fuzzy Logic in Student Modeling", \emph{Advances in Personalized Web-Based Education}, Springer International Publishing, 2015

% 3
\bibitem{IEEEhowto:ingoley}
Shilpa Ingoley, J.W. Bakal “Use of Fuzzy Logic in Evaluating Students’ Learning Achievement ”, \emph{International Journal on Advanced Computer Engineering and Communication Technologies(IJACECT)}, November 2012, 2278-5140 Volume-1, Issue, 2012.

% 4
\bibitem{IEEEhowto:Gokmen}
G. Gokmen, T.Ç. Akinci, M. Tektaş, N. Onat, G. Kocyigit, N. Tektaş, "Evaluation of student performance in laboratory applications using fuzzy logic" \emph{Procedia Soc. Behav. Sci., 2 (2010)}, pp. 902–909

% 5
\bibitem{IEEEhowto:Shilpa}
Shilpa N. Ingoley, J. W. Bakal, "Evaluating Students’ Performance using Fuzzy Logic" \emph{IJCA Proceedings on International Conference on Recent Trends in Information Technology and Computer Science 2012}

% 6
\bibitem{Wang}
Xu, D., Wang, H., Su., K. "Intelligent student profiling with fuzzy models." \emph{In HICSS’02, 35th Annual Hawaii international conference on system sciences.}

% 7
\bibitem{hameed}
Ibrahim A. Hameed and Claus G. Sorensen (2010). "Fuzzy Systems in Education: A More Reliable System for Student Evaluation", \emph{Fuzzy Systems, Ahmad Taher Azar (Ed.)}, InTech, DOI: 10.5772/7216. Available from: http://www.intechopen.com/books/fuzzy-systems/fuzzy-systems-in-education-a-more-reliable-system-for-student-evaluation

% 8
\bibitem{IEEEhowto:Huapaya}
Huapaya, Constanza Raquel. "Proposal of fuzzy logic-based students' learning assessment model." \emph{XVIII Congreso Argentino de Ciencias de la Computación. 2012.}


% 9
\bibitem{IEEEhowto:zadeh}
L. A. Zadeh, "Fuzzy sets", \emph{Inform. Contr.}, vol. 8, pp. 338-353, 1965.

%10
\bibitem{klir}
Klir, G.J., Yuan, B., "Fuzzy Sets, Fuzzy Logic, and Fuzzy Systems", \emph{Selected Papers by Zadeh L.A} World Scientific, Singapore 

% 11
\bibitem{IEEEhowto:adeleke}
Adeleke Raheem Ajiboye, Ruzaini Abdullah Arshah, Hongwu Qin, "Risk Status Prediction and Modelling Of Students’ Academic Achievement - A Fuzzy Logic Approach" \emph{Research Inventy: International Journal Of Engineering And Science}, Vol.3, Issue 11 (November 2013), PP 07-14
